({
    ...
    saveRecords : function(component,event){
        ...
        var fieldsList= ['Date','Particulars', 'Voucher Type','Voucher No.','CC','Voucher Ref. No.','GSTIN/UIN','GST Code','Revenue','State','AM','Zone','Remarks','Sales Manager'];  
        ...
        action.setParams({ 
            ...
            sobjectName:'Account_Revenue__c', 
            fields:fieldsList});
